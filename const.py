...
- "Сборки для проекта <наименование проекта>" Я верну список наименованияий сборок, доступных для управления, у выбранного проекта.
- "Статус сборки <наименование Сборки>" Я верну актуальный статус сборки.
Команды управления:
